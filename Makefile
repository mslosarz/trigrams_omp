...
INC = -Iinclude
CFLAGS = -std=c++11 -Wall -fexceptions -fopenmp
RESINC = 
LIBDIR = 
LIB = -lgomp
LDFLAGS = -fopenmp
...
DEP_DEBUG = 
OUT_DEBUG = bin/Debug/trigrams_omp
...
$(OBJDIR_DEBUG)/src/TrigramProcessor.o: src/TrigramProcessor.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c src/TrigramProcessor.cpp -o $(OBJDIR_DEBUG)/src/TrigramProcessor.o
...
$(OBJDIR_RELEASE)/src/TrigramProcessor.o: src/TrigramProcessor.cpp
	$(CXX) $(CFLAGS_RELEASE) $(INC_RELEASE) -c src/TrigramProcessor.cpp -o $(OBJDIR_RELEASE)/src/TrigramProcessor.o
